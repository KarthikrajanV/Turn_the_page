...
import loginImg from "../images/login2.avif"
import useAuth from '../utils/AuthUtils'
import { signInWithGithub } from '../utils/GitLogin';
  ...
  return (
    ...
    <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-6">
            <div>
                <Link to='/'>
                    <h1 className=' font-goChiHand text-5xl font-bold text-center pt-8'>Turn the page</h1>
                </Link>
            </div>
        ...
        <div class="flex-1 bg-orange-200 text-center hidden lg:flex">
        <div className="m-12 xl:m-16 h-[500px]  overflow-hidden rounded-lg  bg-contain bg-center bg-no-repeat">
            <img src={loginImg} className=' flex items-center' alt="" />
        </div>
